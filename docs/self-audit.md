...
| 39 | Phase 0 specification-audit docs (§33) | **PARTIAL** | `docs/` | architecture, requirements-matrix, scoring/hype/clustering/leakage models, 2 ADRs written; several named model docs (feature-model, value-chain-model, threat-model, etc.) are summarized in `architecture.md` rather than separate files |
