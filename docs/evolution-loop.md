...
3. Optional: provisional entities for unresolved mentions (explicit type policy)
4. Keep self-audit honest on Windows engine-only gate / Docker PARTIAL
